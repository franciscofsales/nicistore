                ...
                <div className="info-page__content">
                    <div className="info-page__block">
                        ...
                        <div className="info-page__support">
                            <p>
                                Para qualquer problema relativo com a loja online, p.f. contactar através de <a href="mailto:gearl@dicci.eu">geral@dicci.eu</a> ou através da redes sociais.<br />
                              Obrigado.
                            </p>
                        </div>
                    </div>
                    <div className="info-page__block">
                        ...
                        <div className="info-page__shipping">
                            ...
                            <p>
                                ...
                                <ul>
                                    <li>3,40€ para encomendas com valor até 50€</li>
                                    <li>Grátis para encomendas com valor superior a 50€</li>
                                </ul>
                            </p>
                            <p>
                                Válido para Resto da Europa:
                                <ul>
                                    <li>12.36€ para encomendas com valor até 100€</li>
                                    <li>Grátis para encomendas com valor superior a 100€</li>
                                </ul>
                            </p>
                            <p>
                    ...
                    <div className="info-page__block">
                        ...
                        <div className="info-page__terms-and-conditions">
                            ...
                            <p>
                                Os Termos e Condições Gerais de Venda que se seguem regulamentam a oferta e a venda de produtos no nosso sítio web (“dicci.eu”)<br />
                              Os produtos adquiridos nos sítios web DICCI são vendidos directamente por DICCI Lda (de ora em diante designado por DICCI).<br />
                            Informações sobre a nossa Empresa: DICCI é uma marca comercial com sede social em Portugal: DICCI – Porto Alguma coisa NIF: 12345667<br />
                          Recordamos também que os utilizadores têm o direito de solicitar e receber apoio da DICCI sobre encomendas e entregas ou como fazer compras on-line no prazo de 72 horas úteis a partir do momento em que o pedido é recebido (salvo motivos de força maior).
                            </p>
                            <p>
                                Todos os pedidos devem ser feitos através da página web destinada para o efeito, sendo possível em caso de dúvida contactar o centro de apoio ao cliente através de emails para o endereço criado para o efeito, seja através do nº de apoio existente, ou outro meio disponível. Quanto mais informações nos proporcionar melhor e mais rapidamente poderemos dar-lhe apoio e mais eficiente será o nosso serviço. Informações adicionais sobre as suas encomendas e estado da entrega, serão disponibilizadas ao utilizador, assim que alguma alteração do estado da encomenda exista. Todas as comunicações serão enviadas para o seu endereço electrónico (e-mail) registado no acto da encomenda. As informações legais relativas a compras on-line e entregas estão disponíveis na respectiva secção de “Termos e Condições Gerais de Venda” e “Política de Privacidade” na nossa página web.
                            </p>
                            <p>
                                <strong>1. A nossa política comercial</strong><br />
                                1.1 Os produtos DICCI presentes no catálogo on-line e os serviços comerciais previstos estão disponíveis exclusivamente para os seus utilizadores finais, ou seja os “Consumidores”. Os nossos produtos e respectivos preços são válidos se desde que estejam disponíveis nos nossos armazéns.<br />
                              ...
                              1.3 A DICCI reserva-se o direito de não processar encomendas recebidas de utilizadores que não sejam “Consumidores” e qualquer outra encomenda que não cumpra a política comercial da DICCI.<br />
                            1.4 Os presentes Termos e Condições Gerais de Venda regulam exclusivamente a oferta, transmissão e aceitação de encomendas de compra relativas a produtos existentes na loja online da DICCI entre os utilizadores da DICCI e a empresa DICCI.<br />
                          1.5 Os Termos e Condições Gerais de Venda não regulam o fornecimento de serviços ou a venda de produtos por parte de terceiros que estejam em DICCI através de ligações, banners ou outras ligações de hipertexto. Antes de enviar encomendas e adquirir produtos e serviços a estes terceiros, recomendamos aos nossos utilizadores que verifiquem os termos e condições destes, uma vez que a DICCI não pode, em circunstância alguma, ser responsabilizada pelo fornecimento de serviços prestados por terceiros ou pela execução de transacções de comércio electrónico entre utilizadores de DICCI e terceiros.
                            </p>
                            <p>
                                <strong>2. Como celebrar um contrato com DICCI</strong><br />
                                2.1 Para solicitar uma encomenda relativa à aquisição de um ou vários produtos em DICCI, deverá escolher os mesmos na loja online e preencher o formulário de encomenda que é electronicamente enviado para a plataforma alugada para o efeito, seguindo as instruções relevantes ao adicionar um produto ao cesto, ficando a sua compra registada.<br />
                              ...
                              2.3 Considera-se que uma encomenda foi efectuada quando DICCI tenha recebido o seu formulário de encomenda por via electrónica e a informação tenha sido verificada e dada como correcta.<br />
                              ...
                              2.6 As encomendas submetidas a DICCI têm de ser preenchidas em Português ou Inglês, de acordo com o país para onde será enviada a encomenda.<br />
                            2.7 Depois do seu formulário de encomenda ter sido registado, DICCI processará a sua encomenda logo que possível.<br />
                          2.9 DICCI pode não processar pedidos de compra se não houver garantias suficientes de solvabilidade, se as encomendas estiverem incompletas ou incorrectas, ou se os produtos já não estiverem disponíveis. Nas situações acima referidas, informaremos por e-mail que o contrato não foi executado e que DICCI não efectuou a sua encomenda especificando os motivos. Para além das informações fornecidas, DICCI não se encontra nas condições de dar-vos indicações mais detalhadas em relação à disponibilidade do (s) produto (s); portanto uma vez examinada a sua encomenda, DICCI informar-lhe-á através de email ou telefonicamente se alguns dos produtos encomendados por si não estiverem disponíveis. Ressalvadas as disposições das Condições Gerais de Venda, considera-se que a encomenda em questão tem por objecto prestações de venda divisíveis, autónomas e relativas a mais do que uma unidade económica, tantas quantos são os produtos encomendados, tal como foi expressamente concordado entre o Cliente e DICCI com o envio da encomenda e a aceitação da mesma. Consequentemente, no caso em que a execução da encomenda por parte de DICCI seja limitada a alguns dos produtos encomendados devido à indisponibilidade de alguns desses ou por outras razões legítimas, independentes da vontade de DICCI, com o envio da encomenda em questão, o Comprador declara o seu interesse e presta o seu consentimento à execução parcial da compra, limitada aos produtos restantes, que portanto não poderá ser recusada por parte do Comprador, nem poderá consentir ao Comprador a rescisão da referida encomenda. No caso DICCI não se encontre nas condições de aceitar integralmente a encomenda efectuada pelo Cliente, dando origem à aceitação parcial da mesma relativamente aos produtos disponíveis, o eventual exercício do direito de arrependimento previsto pelo art. n° 8 das Condições Gerais de Venda não dará origem a nenhuma despesa de transporte a cargo do próprio Cliente.<br />
                        2.10 A submissão de um formulário de encomenda a DICCI significa a aceitação incondicional e compromisso de observar as disposições dos presentes Termos e Condições Gerais de Venda no contrato que celebra com DICCI. Caso não concorde com algumas das disposições dos presentes Termos e Condições Gerais de Venda, não submeta o seu formulário de encomenda para aquisição de produtos em DICCI e contacte-nos.<br />
                      2.11 Ao submeter um formulário de encomenda, está a aceitar e concordar com os presentes Termos e Condições Gerais de Venda bem como com outras condições igualmente contidas em DICCI através de ligações, incluindo os Termos e Condições Gerais de Venda e Política de Privacidade<br />
                    2.12 Uma vez submetido um formulário de encomenda, DICCI envia-lhe, por e-mail cópia do recibo electrónico da ordem de compra, contendo um resumo da informação relacionada com o formulário de encomenda (Principais características dos produtos, informação detalhada sobre o preço, condições de pagamento e o custo do pedido de expedição para o cliente, endereço onde apresentar eventuais reclamações e serviços de assistência pós-venda).<br />
                  2.13 Ao submeter um formulário de encomenda à DICCI, está a aceitar receber a factura/talão emitidos para efeitos fiscais em formato Físico conjuntamente com a encomenda efectuada.
                            </p>
                            <p>
                                <strong>3. Garantias e Indicação do Preço do Produto</strong><br />
                                3.1 Os produtos para venda em DICCI são de qualidade superior, de acordo com os standards europeus, depois de passados pelos testes de qualidade. Estes testes são supervisionados pela DICCI.<br />
                              3.2 As principais características dos produtos são apresentadas na DICCI na página web de cada produto. Os produtos oferecidos para venda na DICCI podem não corresponder exactamente ao real em termos de imagem e cores devido ao browser da Internet ou ao monitor usados. As imagens apresentadas têm um efeito meramente indicativo. As características técnicas de um produto, as homologações e declarações de segurança de um produto de marca DICCI e de qualquer outro produto vendido através do sítio são indicadas na etiqueta ou na embalagem ou nas instruções de utilização do produto e podem estar referidas na totalidade ou em parte no próprio sítio junto da ilustração do Produto. Todos os produtos de marca DICCI respeitam os standards e estão homologados conforme quanto previsto pelas normas da Comunidade Europeia.<br />
                          ...
                          3.6 Caso decida exercer o seu direito de devolução dos produtos adquiridos, DICCI tem o direito de não aceitar produtos que sejam devolvidos sem a correspondente etiqueta ou caso estes tenham sofrido alterações ao estado original ou ainda caso estes se apresentem danificados (por ex. sem etiqueta ou estragados)<br />
                            ...
                            <p>
                                Para Queixas e Reclamações – <a href="mailto:vendas@dicci.eu">vendas@dicci.eu</a><br />
